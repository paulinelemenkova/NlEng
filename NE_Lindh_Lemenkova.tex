...
The test performed on soil specimens aimed at measuring the compression wave velocity (P-wave) and compressive strength (UCS). Unlike the measurements performed on stabilized soil for lime/cement column reinforcement, all seismic measurements were performed on the specimens without pipes. In addition to the above tests, the viscosity data were determined according to the Marsh cone on recipes A to D without the addition of clay. The mixed clay recipes gave no results in the Marsh cone measurements because no material passed the funnel. Furthermore, temperature measurements were carried out according to the thermos method on Cem II (100\%) with a vct of 1.0 and Cem II/LKD (50/50\%) with a vbt of 1.0. Steel thermoses with a liquid volume of 0.5 l were used for the experiment.
