...
For this, extra reference tests were carried out which were to be used for calibration of seismic measurement in relation to compressive strength at 7 and 14 days, Figure \ref{Fig:01} b). The experimental design for the amount of binder 100 kg of binder per $m^3$ of clay was supplemented with internal points. The internal points increase the resolution of the response surface. Red ring shows point that can be excluded from the analysis, Figure  \ref{Fig:01} b).
...
In the testing of binder combinations, a reference recipe of Cem II and quicklime was used in a mutual ratio of 50/50. Evaluated shear strength for the reference samples at different curing times is reported in Figure \ref{Fig:02}.
...
\begin{figure}[H]
 \centering
  ...
  \caption{Compressive strength of specimens with different binder combinations. The test is carried out in accordance with EN 196-1. PresafeP = CKD. The testing is carried out by CEMEX.}\label{Fig:06}
\end{figure}
...
\begin{figure}[H]
 \centering
  ...
  \caption{The compressive strength as a function of cement content for different curing times. Tests carried out according to EN 196-1. by CEMEX.}\label{Fig:07}
\end{figure}

The setting time and water requirement of the different binder combinations were investigated according to EN 196-3, Figure \ref{Fig:08}. Water requirement was the highest for binder combinations 50\% CEM II and 50\% CKD and for 50\% CEM II, 30\% LKD and 20\% limestone filler. The water requirement for 50\% CEM II and 50\% LKD was the same as for pure CEM II. The bonding time varied from 165 to 250 minutes. The admixtures with 50\% LKD and 50\% CKD, respectively, had a significantly longer setting time compared to CEM II, Figure \ref{Fig:08}.

\begin{figure}[H]
 \centering
    \includegraphics[width=0.45\textwidth]{Fig_08.jpg}\\
  \caption{Water requirement and setting time of the different binders. PresafeP = CKD. The tests carried out by CEMEX.}\label{Fig:08}
\end{figure}
...
\newpage
\section{Simulation of seismic measurements}
