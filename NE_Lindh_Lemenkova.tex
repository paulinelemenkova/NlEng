...
\begin{abstract}
{In this article we presented a framework to explore strength characteristics of soil using applied geophysical methods. The core of our work is a systematic assessment of the effects on soil stabilization from various binders. The specimens include clayey soil collected in central Sweden, Stockholm County. The aim was to evaluate shear and compressive strength and analyse P-wave velocities. The binders were combined from four stabilizing agents: 1) Cem II/A, a Portland limestone cement, 2) burnt lime; 3) lime kiln dust (LKD) limited up to 50\%; 4) cement kiln dust (CKD). Clay was added in various ratios (17\%, 30\%, 37.5\% and 58\%) to evaluate the performance of soil with various clay content against binders. Four recipes were presented with varied ratios of these binders. For jet grouting, Cem II/A-M, LKD and CKD were added. The binders corresponded to 80, 100 and 120 kg per $m^3$ of clay. Shear strength was evaluated as a function of P-wave velocity and shown a nonlinear dependance as an exponential curve. The P-waves were measured by ceramic shear ICP® accelerometer and vibration induced by a hammer. The natural frequency analysis was modelled to simulate resonant frequencies as eigen values. The results shown variations in strength and proved that Cem II/A-M (Recipe A, 100\% Cem II) has the best performance for weak soil stabilization followed by the combinations: Recipe B (70\% Cem II/A-M, 30\% LKD), Recipe C with added 80\% Cem II/A-M and 20\% CKD and Recipe D (70\% Cem II/A-M 30\% CKD).}
\end{abstract}
...
Figure \ref{Fig:11} shows a nonlinear dependance of the P-wave velocity from curing time for recipes A to D. Here the Recipe A (100\% cement) shows the most effective results with outperforming the other blended mixtures with the P-wave velocity at 2350 m/s on day \nth{28}. 
