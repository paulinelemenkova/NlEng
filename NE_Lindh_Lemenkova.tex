...
The construction industry is strongly dependent on the advanced technologies of soil improvement. The most challenging issue in construction techniques consists in finding the optimal solutions for the best results in soil stabilization. While the application and recommendation regarding general standards of ground improvement are available in the existing technical and engineering documentation, more complex issues related to nonlinear analysis of soil behaviour have not yet been widely accessible and require special studies. In a response to this need, the optimised design of experiments on soil improvement workflow and the quality control for strength in soil stabilized by various combinations of binders monitored using advanced statistical methods of data processing are presented in this paper. 
