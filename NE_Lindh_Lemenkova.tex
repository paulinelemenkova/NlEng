...
\author*[2]{Polina Lemenkova}
  ...
  \title{\huge Shear strength and compressive strength in clay treated with recipes for K/C depth stabilization and jet injection: a case of Norvik, Nynäshamn Municipality, Stockholm County}
...
Testing of the binder recipes has been carried out partly by SGI and partly by CEMEX. Surveys included 3 types of tests: 1) UCS, 2) Water requirements; 3) Binding time for the 4 types of soil-binder mixtures: 1) CEM II (100\%); 2) CEM II/CKD (50\%/50\%); 3) CEM II/LKD (50\%/50\%); 4) CEM II/LKD/LSfiller (50\%/30\%/20\%). The binder combinations were tested for jet pillar reinforcement and summarise din Table \ref{tab:1} where J=performed, N=not performed.
